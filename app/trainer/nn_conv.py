...
def rubik_deep_model(YawPitchRoll):
    """
    ...
    ypr_shape = YawPitchRoll.shape
    input_ypr = Input(shape=(ypr_shape[1], ypr_shape[2], ypr_shape[3]))
    conv2d_1 = Conv2D(filters=conv2d_filters_1, kernel_size=3, padding='same', data_format='channels_last', activation='relu')(input_ypr)
