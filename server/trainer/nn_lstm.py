...
def lstm_rubik_model(no_feat, pad, no_solvers):
    """
    ...
    hidden_1 = Dense(units=num_hidden_units, activation='relu')(merge_layer)
    # Dropout layer after first hidden layer
    dropout_1 = Dropout(rate=0.10)(hidden_1)
    # Modify this parameter if necessary
    num_hidden_units = 50
    # Second dense hidden layer after merge
    hidden_2 = Dense(units=num_hidden_units, activation='relu')(dropout_1)
